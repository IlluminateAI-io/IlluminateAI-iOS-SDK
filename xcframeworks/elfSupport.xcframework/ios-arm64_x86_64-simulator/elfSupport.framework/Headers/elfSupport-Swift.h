...
#ifndef ELFSUPPORT_SWIFT_H
#define ELFSUPPORT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="elfSupport",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIImage;
@interface UIColor (SWIFT_EXTENSION(elfSupport))
...
@interface UILabel (SWIFT_EXTENSION(elfSupport))
- (void)localize;
@end

@interface UITextField (SWIFT_EXTENSION(elfSupport))
- (void)localize;
@end
